        ...
        bool includeFeatureSummaries = false, string defaultQueryScope = "all")
    {
        ...
        object envelope = new
        {
            ...
            features = new object[]
            {
                ...
                new { id = "fsharp-semantic-indexed-file-exists", summary = "v0.12.92 Exists proves indexed presence including web.config; missing, excluded, and unproven paths fail closed" },
