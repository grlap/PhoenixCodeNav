...
public static class GitInfo
{
    ...
    // -c core.fsmonitor=false: on fsmonitor/Scalar-enabled monorepos git auto-spawns a background
    ...
    /// StandardOutput.ReadToEnd on a work monorepo). The old shape — synchronous ReadToEnd BEFORE
