...
/// Same-language name collisions (the monorepo's net-old/net-new pairing idiom) resolve to the
...
internal static class AssemblyRefEdges
{
        ...
        IReadOnlyDictionary<string, long> projectIdsByRelPath)
    {
        ...
        // monorepo's net-old/net-new idiom pairs csprojs under ONE assembly name — including the
