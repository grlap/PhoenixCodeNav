...
{
    Console.WriteLine("=== Semantic layer scenario (cluster loading across thousands of projects)");
    ...
    {
        var (d, r, _, _) = await sem.DefinitionAsync(usagePath, usageLine, usageCol, null, 120000);
