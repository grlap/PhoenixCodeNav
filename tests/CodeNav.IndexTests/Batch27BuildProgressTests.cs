...
/// <summary>
/// Bead two (field-requested, un-parked during the v5 monorepo reindex): state:'building' was a
/// binary — callers (and the user watching a rebuild across thousands of projects) had no idea
/// whether to wait.
