...
public class Batch26AssemblyRefEdgeTests
{
    ...
    private static void WriteFieldShapedWorkspace(string root, bool emitDll)
    {
        ...
        // The DECLARER is a same-AssemblyName pair too (field 0.7.2 regression: the monorepo's
        ...
        // The field P1's REAL ingredient: a same-AssemblyName csproj PAIR (the monorepo's
