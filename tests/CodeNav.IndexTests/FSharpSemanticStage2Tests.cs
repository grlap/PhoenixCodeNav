...
public partial class FSharpSemanticStage2Tests
{
    ...
    public void ReferencesReturnsOnlyCompilerBoundNonDefinitionUsesFromSelectedProject()
    {
        ...
        try
        {
            ...
            Assert.DoesNotContain("fsharp_references_workspace_dependents_not_scanned",
    ...
    public void ReferencesConsumerPositionAttributesChangedDeclaringBinary()
    {
        ...
        try
        {
            ...
            Assert.Contains("fsharp_references_declaring_project_failed",
                response.GetProperty("partialReason").GetString());
            Assert.Equal("exact",
                response.GetProperty("meta").GetProperty("confidence").GetString());
        }
    ...
    public void ReferencesDiscloseIncompleteEvaluatedDependentDiscovery()
    {
        ...
        try
        {
            ...
            Assert.True(response.GetProperty("totalIsLowerBound").GetBoolean());
            Assert.Contains("fsharp_references_dependent_discovery_incomplete",
                response.GetProperty("partialReason").GetString());
            Assert.Equal("exact",
                response.GetProperty("meta").GetProperty("confidence").GetString());
            JsonElement coverage = response.GetProperty("coverage");
    ...
    public void ReferencesShareTheExistingSourceBudgetAcrossWorkspaceDependents()
    {
        ...
        try
        {
            ...
            Assert.Equal(0, coverage.GetProperty("dependentsPending").GetInt32());
            Assert.Contains("fsharp_references_dependent_failed",
                response.GetProperty("partialReason").GetString());
    ...
    public void ReferencesContinueAfterDependentFailuresAndAttributeExcludedConsumers()
    {
        ...
        try
        {
            ...
            Assert.Contains("fsharp_references_dependent_failed", partialReason);
            Assert.Contains("fsharp_references_dependent_discovery_incomplete", partialReason);
            Assert.Contains("fsharp_references_unsupported_boundary", partialReason);
            Assert.Contains("fsharp_references_binary_dependents_not_scanned", partialReason);
            Assert.Equal("exact",
                response.GetProperty("meta").GetProperty("confidence").GetString());
        }
        finally
    ...
    public void ReferencesDeadlineKeepsCompletedRootEvidenceAndReportsPendingDependents()
    {
        ...
        try
        {
            ...
            Assert.False(coverage.GetProperty("workspaceComplete").GetBoolean());
            Assert.Contains("fsharp_references_workspace_deadline",
                response.GetProperty("partialReason").GetString());
    ...
    public void FSharpSemanticConfidenceDefaultsUnknownAndAuthorityLossToIndexed()
    {
        ...
        Assert.Equal("exact", NavigationTools.FSharpSemanticConfidence(string.Join(';',
            ...
            "fsharp_references_dependent_failed",
            "fsharp_references_dependent_discovery_incomplete",
            "fsharp_references_declaring_project_failed",
            "fsharp_references_unsupported_boundary",
            "fsharp_references_binary_dependents_not_scanned")));
    ...
    public void ErrorDiagnosticsAreStructuredSanitizedAndMakeTheResultPartial()
    {
        ...
        try
        {
            ...
            Assert.DoesNotContain("fsharp_references_workspace_dependents_not_scanned",
                references.GetProperty("partialReason").GetString());
            Assert.True(references.GetProperty("coverage")
                .GetProperty("workspaceComplete").GetBoolean());
