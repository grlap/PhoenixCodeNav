...
/// &lt;Reference&gt;+HintPath (the monorepo's multi-staged build). The difference matters for
...
public class Batch36EdgeProvenanceTests
{
    ...
    // UNBUDGETED — a deep, wide monorepo graph with 10 path variants exceeds the
    ...
    public void DependencyPathStaysWithinHardBudgetOnDeepWideGraphs()
    {
        ...
        try
        {
            ...
            static string Name(int layer, int c) =>
                $"Acme.Monorepo.Enterprise.Platform.Integration.Layer{layer:D2}.Component{c}.ServiceHostingModuleImpl" +
                new string('X', 300);
    ...
    public void DependencyPathDropsStructuredHopsWhenASingleLongPathExceedsBudget()
    {
        ...
        try
        {
            static string Name(int i) =>
                $"Acme.Monorepo.Enterprise.Platform.Integration.Chain{i:D3}.Component.ServiceHostingModuleImpl";
